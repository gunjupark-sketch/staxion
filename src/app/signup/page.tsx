        ...
        <CardContent className="p-6 sm:p-8">
          ...
          <div className="mt-8 grid gap-3">
            ...
            <button
              ...
              disabled={!!socialLoading}
              className="flex h-12 w-full items-center justify-center gap-2 rounded-lg border border-border bg-card text-sm font-semibold text-text-primary transition-colors hover:bg-gray-50 disabled:opacity-50 min-h-[48px]"
            >
